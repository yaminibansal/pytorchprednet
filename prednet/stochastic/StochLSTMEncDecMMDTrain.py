...
if __name__=="__main__":
    ...
    model = SingleLSTMEncDec(enc_filt_size, enc_ker_size, enc_pool_size, hid_size, dec_filt_size, dec_ker_size, dec_upsample_size, lstm_inp_size, num_samples, num_noise_dims)

    
    hidden = model.init_hidden(10)
    hidden, output = model(X_train[:10], hidden)
