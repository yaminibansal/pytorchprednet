...
for i in range(num_datapoints):
    ...
    x = 18
    y = 18
    dir = 0#npr.choice(np.arange(8), 1)[0] #One of 8 possible directions
    ...
    storage_path = '/home/ybansal/Documents/Research/pytorchprednet/Data/MNIST/deterministic/train/'+str(i)+'.hkl'
...
for i in range(num_valpoints):
    ...
    storage_path = '/home/ybansal/Documents/Research/pytorchprednet/Data/MNIST/deterministic/val/'+str(i)+'.hkl'
    f = open(storage_path, 'w')
